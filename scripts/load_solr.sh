...
curl -O https://raw.githubusercontent.com/monarch-initiative/monarch-app/issue-919-add-maxo-associations-to-ui/backend/src/monarch_py/datamodels/model.yaml
curl -O https://raw.githubusercontent.com/monarch-initiative/monarch-app/issue-919-add-maxo-associations-to-ui/backend/src/monarch_py/datamodels/similarity.yaml
