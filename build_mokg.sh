...
poetry run ingest closure --name mokg

poetry run ingest neo4j-csv --name mokg --duckdb output/mokg.duckdb

cp output/mokg_nodes.neo4j.csv /projects/stars/var/data_services/mokg/mokg_nodes.neo4j.csv
cp output/mokg_edges.neo4j.csv /projects/stars/var/data_services/mokg/mokg_edges.neo4j.csv