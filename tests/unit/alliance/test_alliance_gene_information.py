...
@pytest.fixture
def no_synonym_row():
    return {'symbol': 'evx2', 'name': 'even-skipped homeobox 2', 'soTermId': 'SO:0001217', 'basicGeneticEntity': {'secondaryIds': ['ZFIN:ZDB-EST-990707-74'], 'primaryId': 'ZFIN:ZDB-GENE-980526-215', 'crossReferences': [{'id': 'UniProtKB:Q6PFR9', 'pages': []}, {'id': 'NCBI_Gene:30479', 'pages': []}, {'id': 'PANTHER:PTHR24329', 'pages': []}, {'id': 'UniProtKB:Q98863', 'pages': []}, {'id': 'ZFIN:ZDB-GENE-980526-215', 'pages': ['gene', 'gene/expression', 'gene/wild_type_expression', 'gene/expression_images', 'gene/references']}, {'id': 'ENSEMBL:ENSDARG00000059255', 'pages': []}], 'genomeLocations': [{'assembly': 'GRCz11', 'chromosome': '9', 'startPosition': 2002701, 'endPosition': 2007106}], 'taxonId': 'NCBITaxon:7955'}}

@pytest.fixture
def no_name_row():
    return {'basicGeneticEntity': {'crossReferences': [{'id': 'ENSEMBL:WBGene00000646'}, {'id': 'NCBI_Gene:186749'}, {'id': 'UniProtKB:O61209'}, {'id': 'WB:WBGene00000646', 'pages': ['gene', 'gene/expression', 'gene/references', 'gene/expression_images']}, {'id': 'WB:H17B01.2', 'pages': ['gene/spell']}], 'genomeLocations': [{'assembly': 'WBcel235', 'chromosome': 'II', 'endPosition': 1472260, 'startPosition': 1470565, 'strand': '+'}], 'primaryId': 'WB:WBGene00000646', 'synonyms': ['CELE_H17B01.2', 'col-70'], 'taxonId': 'NCBITaxon:6239'}, 'geneSynopsis': 'Is affected by several genes including daf-2; glp-1; and rrf-3 based on microarray; tiling array; proteomic; and RNA-seq studies. Is affected by twenty-two chemicals including Mercuric Chloride; rotenone; and Tunicamycin based on microarray and RNA-seq studies.', 'soTermId': 'SO:0001217', 'symbol': 'H17B01.2'}
