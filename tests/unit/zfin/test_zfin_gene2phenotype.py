...
@pytest.fixture
def basic_row():
    return {'ID': '341492416', 'Gene Symbol': 'pax2a', 'Gene ID': 'ZDB-GENE-990415-8', 'Affected Structure or Process 1 subterm ID': '', 'Affected Structure or Process 1 subterm Name': '', 'Post-composed Relationship ID': '', 'Post-composed Relationship Name': '', 'Affected Structure or Process 1 superterm ID': 'ZFA:0000042', 'Affected Structure or Process 1 superterm Name': 'midbrain hindbrain boundary', 'Phenotype Keyword ID': 'PATO:0000638', 'Phenotype Keyword Name': 'apoptotic', 'Phenotype Tag': 'abnormal', 'Affected Structure or Process 2 subterm ID': '', 'Affected Structure or Process 2 subterm name': '', 'Post-composed Relationship (rel) ID': '', 'Post-composed Relationship (rel) Name': '', 'Affected Structure or Process 2 superterm ID': '', 'Affected Structure or Process 2 superterm name': '', 'Fish ID': 'ZDB-FISH-150901-29679', 'Fish Display Name': 'pax2a<sup>th44/th44</sup>', 'Start Stage ID': 'ZDB-STAGE-010723-13', 'End Stage ID': 'ZDB-STAGE-010723-13', 'Fish Environment ID': 'ZDB-GENOX-041102-1385', 'Publication ID': 'ZDB-PUB-970210-19', 'Figure ID': 'ZDB-FIG-120307-8'}


@pytest.fixture
def basic_g2p(mock_koza, source_name, basic_row, script, map_cache, tt):
    return mock_koza(source_name, iter([basic_row]), script, map_cache=map_cache, translation_table=tt)
...
def test_excluded_tags(mock_koza, source_name, basic_row, script, map_cache, tt, tag):
    ...
    entities = mock_koza(source_name, iter([basic_row]), script, map_cache=map_cache, translation_table=tt)
