...
class OntologyClass:
    ...
    """
    id: str = Field(None, description="""A unique identifier for an ontology term. Must be either a CURIE shorthand for a URI or a complete URI""")
...
class Association(Entity):
    ...
    primary_knowledge_source: str = Field(None, description="""The most upstream source of the knowledge expressed in an Association that an implementer can identify (may or may not be the 'original' source).""")
