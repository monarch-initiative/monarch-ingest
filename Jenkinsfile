        ...
        stage('index') {
            steps {
                sh '''
                    ...
                    python3 monarch-file-server/scripts/directory_indexer.py -v --inject monarch-file-server/scripts/directory-index-template.html --directory data-public --prefix https://data.monarchinitiative.org -x > directory-indexer.log 2>&1
                '''
            }
        }
    }
