...
@typer_app.command()
def transform(ingest_config_file: str = None, output_dir: str = OUTPUT_DIR, row_limit: int = None,  ontology: bool = False, all: bool = False, force: bool = False):
    """
    ...
    if ontology:
        ...
        transform_all(output_dir, row_limit=row_limit, force=force)
    else:
